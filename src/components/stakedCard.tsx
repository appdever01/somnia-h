    ...
    <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 border-2 border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-[1.02]">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <div className={
            ...
            (props.status === "active" && status === "matured" ? " bg-green-100" :
             props.status === "active" ? " bg-blue-100" :
             props.status === "withdrawn" ? " bg-gray-100" : " bg-orange-100")
          }>
        ...
        <div className="text-right">
          <div className={
            ...
            (props.status === "active" && status === "matured" ? " bg-green-100 text-green-800" :
             props.status === "active" ? " bg-blue-100 text-blue-800" :
             props.status === "withdrawn" ? " bg-gray-100 text-gray-800" : " bg-orange-100 text-orange-800")
          }>
      ...
      <div className="bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200 rounded-xl p-4 mb-6">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-emerald-700 text-sm font-medium">Expected Earnings</p>
          ...
          <div className="text-right">
            {status === "ongoing" && timer ? (
              <div>
                ...
                <p className="text-gray-800 font-bold text-lg">{formatTime(timer)}</p>
              </div>
            ) : status === "matured" ? (
